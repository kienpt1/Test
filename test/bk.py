    ...
    for data in raw_data:
        ...
        if extracted_data["Type"] == "ALM":
            ...
            if ac_status == "1":
                ...
                if gen_status == "1":
                    alert_descriptions.append("Có điện AC - Máy phát vẫn chạy (không bình thường)")
                elif gen_status == "0":
                    alert_descriptions.append("Có điện AC - Máy phát đã tắt")
                else:
                    alert_descriptions.append("Có điện AC")
...
def main():
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            if last_sent is None or (now - last_sent).total_seconds() > 120:
                json_payload = {
                    "status": "ok",
                    "Location": loc or "",
                    "EQID": eqid,
